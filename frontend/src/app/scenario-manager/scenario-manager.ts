...
@Component({
  ...
  imports: [MatPaginatorModule, MatInputModule, MatSortModule, MatTableModule, MatSlideToggleModule],
...
export class ScenarioManager {
  ...
  displayedColumns: string[] = ['enableScenario', 'id', 'name', 'description', 'path', 'timeoutMs', 'statusCode', 'latencyMs'];
