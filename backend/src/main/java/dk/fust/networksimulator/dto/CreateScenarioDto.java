...
@Data
@NoArgsConstructor
@Schema(description = "DTO used when creating a scenario")
public class CreateScenarioDto {

    @Schema(description = "Whether the scenario is enabled", example = "true")
    ...
    @Schema(description = "Request path to match (prefix or exact)", example = "/api/v1/resource", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    @Size(max = 2000)
    private String path;
