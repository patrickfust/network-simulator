...
Requests made to the path `/_/` are handled by the backend itself, providing API endpoints for managing simulation scenarios.
All other requests are proxied to the target service, applying the configured network simulation scenarios.

### OpenAPI/Swagger Documentation

The API documentation is available at:
http://localhost:9898/_/swagger-ui/index.html
